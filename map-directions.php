...
function head(){
    ...
    ?>
    <link rel="stylesheet" href="/assets/phocamaps/phocamaps.css" type="text/css" />
    <script type="text/javascript" src="http://www.google.com/jsapi"></script>
    <script type="text/javascript" src="/assets/phocamaps/base64.js"></script>
...
<?php
    ...
    <div class="info-box">
        <img src="/assets/images/globe.jpg" alt="globe" class="img-responsive" />
        
        <p>Baldwin Sennecke Halman LLP</p>
        <p>
        Victoria Tower<br>
        25 Adelaide Street East<br>
        Toronto, ON M5C 3A1
        </p>
